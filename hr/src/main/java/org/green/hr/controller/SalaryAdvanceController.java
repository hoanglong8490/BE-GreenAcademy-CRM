...
public class SalaryAdvanceController {
  ...
  ResponseEntity<CoreResponse> updateSalaryAdvance(@PathVariable("salaryAdvanceId") @Valid long salaryAdvanceId,
      @RequestBody @Valid SalaryAdvanceDTO salaryAdvanceDTO) {
    SalaryAdvanceDTO updateSalaryAdvance = salaryAdvanceService.updateSalaryAdvance(salaryAdvanceId, salaryAdvanceDTO);
    CoreResponse response = new CoreResponse()
        .setCode(SUCCESS)
        .setMessage(SUCCESS_MESSAGE)
  ...
  ResponseEntity<CoreResponse> deleteSalaryAdvance(@PathVariable("salaryAdvanceId") long salaryAdvanceId) {
   SalaryAdvanceDTO deletedSalaryAdvance = salaryAdvanceService.deleteSalaryAdvance(salaryAdvanceId);
    CoreResponse response = new CoreResponse()
        .setCode(SUCCESS)
        .setMessage(SUCCESS_MESSAGE)
  ...
  ResponseEntity<CoreResponse> getSalaryAdvanceById(@PathVariable("salaryAdvanceId") long salaryAdvanceId){
    CoreResponse response = new CoreResponse()
        .setCode(SUCCESS)
        .setMessage(SUCCESS_MESSAGE)
